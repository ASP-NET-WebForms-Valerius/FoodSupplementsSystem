...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="/public/viewtopics">See Details &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="/foodsupplements/supplements">See Details &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            <h2>Famous Brands</h2>
            ...
            <p>
                <a class="btn btn-default" href="/public/viewbrands">See Details &raquo;</a>
            </p>
        </div>
    </div>
