            ...
            <div class="raw">
                ...
                <div class="col-md-6 table-bordered-none-byMe">
                    <asp:DropDownList ID="DropDownListRateValues" runat="server" 
                        CssClass="pull-right center table-bordered-none-byMe"
                        AutoPostBack="true" 
                        Width="30px"
                    ...
                    <h4 class="pull-right dark-orange-fg table-bordered-none-byMe" style="margin: 0; padding: 0;"> vote here. </h4>
                </div>
            </div>
            <!-- Add the extra clearfix for only the required viewport -->
            <div class="clearfix visible-md"></div>
            <div class="raw">
                <div class="col-md-8 col-md-offset-4 pull-right table-bordered-none-byMe">
                ...
                <asp:ListView ID="ListViewSupplementDetails" runat="server" 
                    ...
                    <ItemTemplate>
                        ...
                        <li>                
                            ...
                            <div class="clearfix visible-md"></div>
                            <div class="raw">
                                <div class="col-md-8 col-md-offset-2 table-bordered-none-byMe">
